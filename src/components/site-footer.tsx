        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-4">
              <a href="https://www.instagram.com/newvalkyria_ac?igsh=N3E5YzNtYzdqd241" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/70 transition-colors hover:text-white">
              ...
              <a href="https://www.facebook.com/share/1EQAe9xVfE/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/70 transition-colors hover:text-white">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
          ...
          <div>
            <div className="footer-cta-card">
              <Image src={logo} alt="New Valkyria" className="footer-cta-logo" />
              <p className="mt-3 font-display text-lg uppercase tracking-[0.05em] text-white leading-tight">
                Inscription ouverte
              </p>
              <Link
                href="/inscription"
                className="mt-4 inline-flex items-center rounded-lg bg-accent px-5 py-2.5 text-xs font-bold uppercase tracking-[0.14em] text-ink transition hover:bg-accent-soft"
              >
